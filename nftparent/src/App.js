  ...
  return (
    <div>
      <div className="App-Navbar" >
        <Link to="/"><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQT2gninE2Mp0JA80jbmqCtAEv6U1lDozMJOg&usqp=CAU' alt="NFT Parent" height="100" width="150"/><h1>Parent</h1></Link>
        ...
        <div className="App-Main">
          ...
          <Route exact path="/diaper/:id/update" component={DiaperDetail} />
        </div>
        {/* <div>
